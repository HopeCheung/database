...
class RDBDataTable(BaseDataTable):
    ...
    def join_by_template(self, template, children, field_list=None, limit=None,
                         offset=None, order_by=None, commit=True, cons=None):
        result = None
        ...
        try:
            ...
            q = "select {} from " + referenced_table_name
