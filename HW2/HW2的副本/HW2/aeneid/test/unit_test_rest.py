...
def test_get2():
    ...
    querystring = {"children": "appearances,batting,nameLast=Williams,batting.yearID=1960,appearances.yearID=1960",
                   "fields": "playerID,nameLast,nameFirst,batting.AB,batting.H,appearances.G_all,appearances.GS"}

    payload = ""
    headers = {
        'cache-control': "no-cache",
        'Postman-Token': "374e3cf5-c3d1-4cb7-b36a-4441d977be9a"
    }
