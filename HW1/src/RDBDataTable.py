...
class RDBDataTable(BaseDataTable):
    ...
    def find_by_primary_key(self, key_fields, field_list=None):
        ...
        dic = {self._key_columns[i]:key_fields[i] for i in range(len(key_fields))} 
        where, args = self._template_to_where_clause(dic)
        if field_list != None:
            q = "SELECT " + "{}" + " From " + self._table_name + " " + where + ";" 
        else:
            q = "SELECT " + "*" + " From " + self._table_name + " " + where + ";"
    ...
    def delete_by_template(self, template):
        ...
        cursor = self._cnx.cursor()
        where, args = self._template_to_where_clause(template)
        q = "DELETE FROM " + self._table_name + " " + where + ";"
        self._run_q(q, args)
        return r
        pass
    ...
    def update_by_template(self, template, new_values):
        ...
        q = "UPDATE " + self._table_name + " SET " + ", ".join(terms) + " " + where
