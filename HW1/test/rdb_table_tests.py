...
#load 
bat_obj = RDBDataTable.RDBDataTable("Batting", ["playerID","yearID","stint","teamID"])
peo_obj = RDBDataTable.RDBDataTable("People", ["playerID"])
...
print(bat_obj.find_by_template({"teamID":"Columbia"}))
